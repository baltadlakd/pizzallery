...
<div class="row">
  ...
  <div v-for="item in laravelData.data" class="col-sm-6 col-md-4 col-lg-3 mt-4">
    <div class="card card-inverse card-info">
      <img class="card-img-top" src="imgs/hamburger.jpg">
...
export default {
  mounted(){
    console.log("VUE_hamburguesaIndex");
  },
  created(){
  ...
  methods:{
    show(id){
      window.location.replace(this.path + "hamburguesa/" + id);
    },
    getHamburguesas(page){
      if(typeof page === 'undefined'){
        page = 1;
      }
      var url = window.location.origin + this.path+"hamburguesa" + "?page=" + page;
